...
public abstract class SpawnEntity extends Action {
    ...
    protected final int PERCENT_DEMOBATS = 2;
    protected final int PERCENT_RATION_BOXES = 4;
    protected final int PERCENT_SPORE_PATCHES = 4;
    protected final int PERCENT_GATES = 2;

    protected abstract int calculateSpawnEntity(WorldMap map);

    protected void spawnEntity(WorldMap map) {
